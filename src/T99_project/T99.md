...
| ช่วงเวลา     | วัน             |
| ------------ | --------------- |
| Proposal     | 8 Dec - 12 Dec  |
| Presentation | 15 Dec - 19 Dec |
...
- ชื่อกลุ่ม
- ระบบจะครอบคลุม Feature อะไรบ้าง
  ...
  - ส่วน Integration
    - อะไรต่อไปไหนบ้าง ใช้วิธีอะไร (diagram)
...
- อธิบายการทำงานของ Flow ต่างๆ
  - ใช้ Diagram จะดีกว่า Screencap `ERPNext`, `Node-RED`
